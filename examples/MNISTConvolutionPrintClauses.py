...
from PySparseCoalescedTsetlinMachineCUDA.tm import MultiClassConvolutionalTsetlinMachine2D, MultiOutputConvolutionalTsetlinMachine2D
...
if __name__ == "__main__":
	...
	for i in range(epochs):
		...
		print(
			f"Epoch {i + 1} | Train Time: {stop_training - start_training:.2f}s, Test Time: {stop_testing - start_testing:.2f}s | Test Accuracy: {result_test:.4f}"
		)
